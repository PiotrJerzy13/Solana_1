...
declare_id!("96fLvxDrkKfkkUw2No8paPdGHMezu2GBayjBfjnXA9rD");

// Dedicated ICO Configuration
pub const ADMIN_PUBKEY: Pubkey = pubkey!("5LxXRkTUtqPQesCJxn7xNogRwih48oN3neY2W2Po8EuA");
...
pub struct BuyTokens<'info> {
    ...
    #[account(mut, address = ADMIN_PUBKEY)]
    pub admin: SystemAccount<'info>, // Use SystemAccount for better validation
